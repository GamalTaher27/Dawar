...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/css/css/firsthome.css">
  ...
  <div class= "container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="/index"><strong>  <span class="glyphicon glyphicon-home"></span> Home</strong></a></li>
          @if(auth::check())
...
<div class="modal fade" id="rateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <form method="POST" action="/posts/rate" enctype="multipart/form-data">
   {{ csrf_field() }}
   <br>
<div class="rating">
  
    <input type="radio" name="grade" value="5" class="form-control" id="star1"><label for="star1"></label>

    <input type="radio" name="grade"  value="4" class="form-control" id="star2" ><label for="star2"></label>

    <input type="radio" name="grade"  value="3" class="form-control" id="star3" ><label for="star3"></label>

    <input type="radio" name="grade"  value="2" class="form-control" id="star4"><label for="star4"></label>
 
    <input type="radio" name="grade"  value="1" class="form-control" id="star5"><label for="star5"></label>
...
<div class="modal" id="messageModal" tabindex="-1" role="dialog" style=" overflow:visible;>
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-lightbulb"></i> Important Safty Tips</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Only meet in public/crowded places for example metro stations and malls.</p>
        <p>Never go alone to meet another user always take someone with you.</p>
