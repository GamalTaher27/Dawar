...
<!-- start cover-->
 <section class="coverpic">
    ...
    font-size: 50px;">Sometimes</span> the things you've lost can be found again in unexpected places</h1>
        <div class="row text-center col-lg-6">
<br>
            <div class="col-lg-6">
                <a class="btn cover-btn btn-lg " href="/lost">VIEW LOST ITEMS</a>
            </div>
            <div class="col-lg-6">
